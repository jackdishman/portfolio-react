		...
		<div className="w-full sm:w-3/4 lg:w-1/2">
			...
			<div className="pt-5">
				...
				<div className="flex justify-between mt-5">
					<a href="https://capsule.social" target="_blank" className="underline">Capsule Social</a>
					<span className="italic">April 2021 - Present</span>
				</div>
				{/* Logo */}
				...
				<div className="py-5">
					<video
						...
						muted 
					>
						<source src={ require(`../assets/blogchain/slide1.webm`)} type="video/webm" />
					</video>
					<div className="text-center mt-2">
						<a href="https://blogchain.app/id/dish" target="_blank" className="text-slate-500 text-sm">View my Profile</a>
						<span className="px-2 text-slate-500"> | </span>
						<a href="https://github.com/capsulesocial" target="_blank" className="text-slate-500 text-sm">View source code</a>
					</div>
				</div>
				{/* Job Description */}
				<div>
					<p className="text-sm mt-2 text-slate-900">As the first full-time employee, I was responsible for building out the Engineering team, setting company culture, and acted as the Technical Expert on investment calls with Venture Capitalists.</p>
